...
public class SecureHashClass
{
    ...
    public static void main(String[] args)
    {
        ...
        String password_entered = sc.nextLine();
        Boolean status = PassBasedEnc.verifyUserPassword(password_entered,encryptedpassword,saltvalue);
        if(status==true)
