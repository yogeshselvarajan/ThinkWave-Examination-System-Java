...
public class HelpForm extends JFrame {
    ...
    public HelpForm() {
        ...
        try {
            JLabel image = new JLabel(new ImageIcon(ImageIO.read(new File("img/Heading1.png"))));
        ...
        try {
            JLabel image = new JLabel(new ImageIcon(ImageIO.read(new File("img/Heading2.png"))));
